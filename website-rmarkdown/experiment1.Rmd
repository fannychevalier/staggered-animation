...
author: Experiment 1 Replication Material
...
### Video instructions
<iframe width="600" height="490" src="https://www.youtube.com/embed/HOuQuE4oCUM" frameborder="0" allowfullscreen></iframe>
...
To run the experiment, unzip the [archive](https://github.com/fannychevalier/staggered-animation/blob/master/The%20Not%20So%20Staggering%20Effect%20of%20Staggered%20Animations%20-%20Experiment%201.zip) and run the Java executable `Experiment1.jar`.
...
* Download the [experimental data (csv file)](https://github.com/fannychevalier/staggered-animation/blob/master/experimental-materials/staggeredAnimation-xp1-logs.csv)
* Downlaod the [R script](https://github.com/fannychevalier/staggered-animation/blob/master/experimental-materials/staggeredAnimation-xp1.R) below

&nbsp;

```{r}
#------------------ LIBRARIES --------------------------#
install.packages(c("ggplot2","boot","gridExtra"), repos="http://cran.utstat.utoronto.ca/")
